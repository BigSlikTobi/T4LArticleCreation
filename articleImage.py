...
class ImageSearcher:
    ...
    async def validate_image_url(self, session: aiohttp.ClientSession, image_data: Dict[str, str]) -> bool:
        url = image_data['url']
        # Add blacklist check
        blacklisted_domains = ['lookaside.instagram.com', 'gettyimages.com', 'shutterstock.com', 'istockphoto.com', 'tiktok.com/', 'fanatics.com',  'static.nike.com', 'c8.alamy.com', 'alamy.com', 'fanatics.frgimages.com', 'redcircle.com', 'ebayimg.com', 'ebay.com', 'ebaystatic.com', 'ebay.co.uk', 'ebay.ca', 'ebay.de', 'ebay.it', 'ebay.fr', 'ebay.es', 'ebay.in', 'ebay.com.au', 'ebay.com.sg']
