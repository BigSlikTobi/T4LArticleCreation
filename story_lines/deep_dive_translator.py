...
def load_prompts():
    """
    Loads required prompts from the prompts.yml file for deep dive translation tasks.
...
async def initialize_llm(model_type="flash"):
    """
    Initializes the LLM model for deep dive translation, using the specified model type (default: 'flash').
